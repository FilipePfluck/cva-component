...
export { CVAComponent, active, after, autofill, before, dark, disabled, enabled, even, first, focus, focusVisible, focusWithin, hover, invalid, last, odd, only, placeholder, required, selector, valid };
